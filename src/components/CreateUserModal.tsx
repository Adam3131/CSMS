...
import { createUser, UserRole } from "../utils/userStore";
...
export default function CreateUserModal({ isOpen, onClose }: CreateUserModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    const result = await createUser(email, role as UserRole, fullName, password);
    setIsLoading(false);

    if (!result) {
      setError("Unable to create this user. The email may already exist or Supabase auth is not available.");
    } else {
